  ...
  agents: [
    {
      ...
      title: 'Senior Principal Migration Agent (MARN: 1804921)',
      specialty: 'Australian GSM (189/190/491), State Nominations & Employer Sponsorship',
      experience: '16+ Years',
    },
    {
      name: 'Sophia Patel',
      title: 'Global University Placement Director (QEAC #E492)',
      specialty: 'Go8 & Russell Group Admissions, GTE & SOP Audits, Scholarships',
      experience: '12+ Years',
    },
    {
      name: 'Marcus Vance',
      title: 'Skills Assessment & Tribunal Specialist (MARN: 1408219)',
      specialty: 'ACS, VETASSESS, Engineers Australia CDR & AAT Refusal Appeals',
      experience: '14+ Years',
    },
    {
      name: 'Elena Rodriguez',
      title: 'North America & Europe Student Advisor (ICEF #0941)',
      specialty: 'US F-1 Visas, Canada PGWP & Express Entry, Germany Tuition-Free Study',
      experience: '9+ Years',
    },
    {
      name: 'Rajesh Kumar',
      title: 'Partner & Family Migration Specialist (MARN: 1901142)',
      specialty: 'Partner Visas (820/801), Parent & Dependent Visas',
      experience: '11+ Years',
    },
    {
      name: 'Chloe Zhang',
      title: 'Regional Skilled PR & Business Agent (MARN: 2015381)',
      specialty: 'Subclass 491 Regional Nomination, State Matrix Strategy (SA, TAS, WA, NSW)',
      experience: '8+ Years',
    },
  ],
